  ...
  return (
    <div className="min-h-screen bg-[#F8F7F4]">
      <div className="max-w-2xl mx-auto px-6 py-12">
        ...
        <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-1">Support</h1>
        ...
        {/* Contact card */}
        <div className="rounded-xl border border-gray-200 dark:border-white/10 bg-white dark:bg-[#1b2128] p-5 mb-2">
          <p className="text-xs font-bold tracking-widest uppercase text-gray-400 dark:text-gray-500 mb-2">Contact</p>
          <a
