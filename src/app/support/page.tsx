  ...
  return (
    <div className="min-h-screen bg-[#F8F7F4]">
      <div className="max-w-2xl mx-auto px-6 py-12">
        ...
        <h1 className="text-3xl font-bold text-gray-900 dark:text-[#E2EAF2] mb-1">Support</h1>
        <p className="text-sm text-gray-600 dark:text-[#8FA4B8] leading-relaxed mb-8">
        ...
        <div className="rounded-xl border border-gray-200 dark:border-[#2D4050] bg-white dark:bg-[#1B2A38] p-5 mb-2">
          <p className="text-xs font-bold tracking-widest uppercase text-gray-400 dark:text-[#5C7A8E] mb-2">Contact</p>
          <a
        ...
        <p className="text-sm text-gray-600 dark:text-[#8FA4B8] leading-relaxed">
          See our <Link href="/privacy" className="text-[#1B6B7B] dark:text-[#2D9DB3] hover:underline">Privacy Policy, Terms of Service, and Community Guidelines</Link>.
        </p>
      </div>
    </div>
  );
