      ...
      <div className="px-5 pb-3">
        ...
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 border border-gray-200 rounded-xl px-3 py-2 text-sm outline-none focus:ring-2 focus:ring-[#1B6B7B]/30 focus:border-[#1B6B7B]"
          />
          <button
            onClick={handleCreateTag}
            disabled={!newTagName.trim() || creating}
            className="px-4 py-2 bg-[#1B6B7B] text-white text-sm rounded-xl disabled:opacity-40 hover:bg-[#155a68] transition-colors"
          >
            Create
          </button>
        </div>
